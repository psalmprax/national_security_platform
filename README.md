...
- **Access Control (ABAC)**: Granular 5-level clearance hierarchy (Top Secret -> Unclassified) with automatic data redaction.
- **Role-Based Access (RBAC)**: JWT-based Role enforcement via Go middleware.
...
- **Main Portal (Dashboard)**: [https://localhost:8085](https://localhost:8085)
- **Agency Command Portal**: [https://localhost:8085/agency/portal](https://localhost:8085/agency/portal)
- **Mobile Client (Simulation)**: [https://localhost:8085/mobile/](https://localhost:8085/mobile/)
- **Security API (Alerts)**: [https://localhost:8085/api/v1/alerts](https://localhost:8085/api/v1/alerts)
- **Security Compliance (Admin)**: [https://localhost:8085/api/v1/system/security-scans](https://localhost:8085/api/v1/system/security-scans)
- **System Pulse (Health)**: [https://localhost:8085/api/v1/system/status](https://localhost:8085/api/v1/system/status)
- **CockroachDB UI**: [http://localhost:8081](http://localhost:8081)
- **MinIO Console**: [http://localhost:9001](http://localhost:9001)
- **Login Portal**: [https://localhost:8085/login](https://localhost:8085/login)
